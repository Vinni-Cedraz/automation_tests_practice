...
#    Updated: 2022/10/29 21:37:03 by vcedraz-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
Scenario: complete_purchase
	...
	Input Text                                  id=email_create	       		emailtest9487@email.com
	...
	Click Element                              	xpath=//select[@id='months' and @class='form-control']
	wait until element is visible               xpath=//option[@value='10']
	Click Element                               xpath=//option[@value='10']
	Click Element                              	id=years
	Click Element                              	xpath=//option[@value='1991']
	...
	Click Element                              	xpath=//option[@value='5']
